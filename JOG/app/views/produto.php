...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container" >
        <a class="navbar-brand" href="../../index.php"><img src="../../assets/imagens/logo%20.png" alt="" width="60px"></a>
            ...
            <div class="row add-to-cart">
                <div class="col-md-5 product-qty">
                    <form action="../controllers/controladorProduto.php?acao=comprar&codigo=<?=$codigo?>" method="post">
                        ...
                        <input type="submit" id="comprar" class="btn btn-lg btn-brand btn-full-width" value="Comprar">
                    </form>
                </div>
            </div><!-- end row -->
